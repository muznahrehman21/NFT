    ...
    <BorderWrapper>
      <div className="flex justify-between items-center px-4 w-full h-full">
        <input
          ...
          className="flex-1 bg-transparent outline-none font-roboto font-medium text-[#FE0101] text-[20px] placeholder-[#FE0101]/70"
        />

        <button
          type="submit"
          className="flex justify-center items-center rounded-[15px] w-[88px] h-[76px] cursor-pointer"
          style={{
            background:
