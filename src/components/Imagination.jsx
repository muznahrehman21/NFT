...
function Imagination() {
  return (
    <div className="top-0 flex flex-col items-center gap-7 py-12 w-[1320px] h-[931px]">
      ...
      <div className="bg-amber-800 w-7xl">
        ...
        <div className="gap-7 bg-amber-300 w-3xs">
          <img src="/im5.png" alt="" className="ml-15 w-[120px] h-[110px]" />
          <img src="/im6.png" alt="" className="ml-15 w-[170px] h-[170px]" />
          <img src="/im7.png" alt="" className="ml-1 w-[120px] h-[120px]" />
          <img src="/im8.png" alt="" className="ml-30 w-[120px] h-[120px]" />
        </div>
      </div>
    </div>
  );
